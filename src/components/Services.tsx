...
export default function Services() {
  ...
  return (
    <section
      id="services"
      className="py-clamp-10-20 text-2xl px-2 bg-gradient-to-t from-muted"
    >
      <div className="container max-w-screen-xl mx-auto py-12 md:py-20 px-4 md:px-10 bg-background rounded shadow relative">
        ...
        <div className="mb-8 md:mb-12 border-l-4 md:border-l-8 border-danger px-4">
          <h2 className="text-clamp-2xl-4xl mb-2 font-poppins text-start text-navy font-bold">
            Soluciones en transporte
          </h2>
          <p className="text-muted-foreground font-poppins font-bold text-xs md:text-base max-w-screen-md">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              />
              <div className="z-40 font-poppins relative w-full h-full flex flex-col justify-end bg-primary/50 hover:bg-primary/60 transition duration-500 p-4">
